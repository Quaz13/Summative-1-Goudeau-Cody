...
import com.company.SummativeApi.model.CustomErrorResponse;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<List<CustomErrorResponse>> summativeValidationError(MethodArgumentNotValidException e) {

        //binding hold in validation errors
